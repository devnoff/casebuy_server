...
-->
					...
					<tr>
						...
						<td width=180 colspan=2><input type=text style=width:100px name=StoreId maxlength=20 value="<?=$StoreId;?>"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type=text style=width:180px name=StoreNm value="CASEBUY"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type=text style=width:180px name=MallUrl value="http://casebuy.me"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type=text style=width:180px name=RtnUrl value="http://casebuy.me/ko/agspay_mobile/AGS_pay_ing.php"></td>
					</tr>
					<tr>
						<td class=clsleft>☞ 취소 URL (150)</td>
						<!-- 고객이 취소를 눌렀을 경우의 이동 URL 경로로 전체 경로로 맞춰 주시기 입니다. -->
						<td><input type=text style=width:180px name=CancelUrl value="http://casebuy.me/ko/agspay_mobile/AGS_pay_cancel.php"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type=text style=width:180px name=MallPage maxlength=100 value="http://casebuy.me/ko/agspay_mobile/AGS_VirAcctResult.php"></td>
					</tr>
					<tr>
						<?php 
							$date = new DateTime();
