		...
		if(Check_Common(form) == true){
			...
			if(document.AGSPay == null || document.AGSPay.object == null){
				...
				if(MakePayMessage(form) == true){										
					...
					var openwin = window.open("/ko/agspay/AGS_progress.html","popup","width=300,height=160"); //"지불처리중"이라는 팝업창연결 부분
...
<form name=frmAGS_pay method=post action="/ko/agspay/AGS_pay_ing.php">
			...
			<tr>
				...
				<table width=650 border=0 cellpadding=0 cellspacing=0>
					...
					<tr>
						...
						<td><input type=text style=width:300px name=MallUrl value="http://www.casebuy.me"></td>
				...
				<table width=650 border=0 cellpadding=0 cellspacing=0>
					...
					<tr>
               		...
               		<tr>
						...
						<td width=300><input type=text style=width:300px name=MallPage value="/ko/agspay/AGS_VirAcctResult.php"></td>
