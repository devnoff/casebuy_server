        ...
        <div class="basic_info">
            ...
            <ul>
                ...
                <li>
                    ...
                    <input class="money_input price_input" name="purchase_price" type="text" style="text-align:right;ime-mode:disabled;" onKeyPress="return numbersonly(event, false)"/>
                </li>
                <li>
                    <label for="">정가(원)</label>
                    <input class="money_input price_input" name="regular_price" type="text" style="text-align:right;ime-mode:disabled;" onKeyPress="return numbersonly(event, false)" />
                </li>
                <li>
                    <label for="">할인율(%)</label>
                    <input class="price_input" name="dc_rate" type="text" style="text-align:right;ime-mode:disabled;" onKeyPress="return numbersonly(event, false)" optional="true"/>
                </li>
                <li>
                    <label for="">할인가격(원)</label>
                    <input class="money_input price_input" name="fixed_dc_amount" type="text" style="text-align:right;ime-mode:disabled;" onKeyPress="return numbersonly(event, false)" optional="true" />
                </li>
                <li>
                ...
                <li>
                    ...
                    <input class="price_input" name="point_rate" type="text" style="text-align:right;ime-mode:disabled;" onKeyPress="return numbersonly(event, false)" optional="true" />
                </li>
                <li>
                    <label for="">적립포인트(포인트)</label>
                    <input class="price_input" name="fixed_point" type="text" style="text-align:right;ime-mode:disabled;" onKeyPress="return numbersonly(event, false)" optional="true"/>
                </li>
                <li>
                ...
                <li>
                    ...
                    <input class="money_input price_input" name="delivery_fee" value="2,500" type="text"style="text-align:right;ime-mode:disabled;" onKeyPress="return numbersonly(event, false)"/>
                </li>
                <li>
                    <label for="">출시일</label>
...
var calculatePrice = function(){
    ...
    */
    ...
    point_amount = parseInt(point_amount * 1);
    ...
    var profit_after_delivery = parseInt(sales_price) - parseInt(purchase_price) + parseInt(delivery_fee) - parseInt(partner_delivery_fee);
    ...
    $('input[name="profit"]').val(profit); //addCommas(profit)
    
    if (profit_after_delivery)
        $('input[name="profit_after_delivery"]').val(profit_after_delivery); // addCommas
        
    if (profit_final)
        $('input[name="profit_final"]').val(profit_final);// addCommas
