...
class Shop extends CI_Controller {
	...
	function addToCart(){
		...
		if (!$member){
			...
			delete_cookie('ko_cart');
			set_cookie('ko_cart',$cookie, 66000);
...
*/
	...
	*/
	function saveOrderFormState(){
		...
		set_cookie('casebuy_orderer',$this->input->post('orderer'),0);
		set_cookie('casebuy_recipient',$this->input->post('recipient'),0);
		set_cookie('casebuy_shouldRestoreOrderForm','true',0);
