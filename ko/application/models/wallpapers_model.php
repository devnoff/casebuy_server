...
class Wallpapers_model extends CI_Model {
    ...
    function wallpaperById($id){
        ...
        $query = $this->db->get_where('caseshop.wallpapers',array('id'=>$id));
        return $query->row();
    }
    ...
    function insert($data){
        ...
        $this->db->trans_begin();
        $this->db->insert('caseshop.wallpapers', $data);
    ...
    function update(){
		...
		$this->db->update('caseshop.wallpapers', $data); 
    ...
    function delete($id){
        $this->db->trans_begin();
        $this->db->delete('caseshop.wallpapers', array('id'=>$id));
        $this->db->delete('caseshop_ko.case_wall', array('wallpapers_id'=>$id));
        $this->db->delete('caseshop.case_wall', array('wallpapers_id'=>$id));
    ...
    */
    ...
    function relatedProductsSimple($wallpapers_id){
        ...
        $this->db->select("products.id products_id, concat('$this->resource_host', app_detail_img) thumb",false);
        $this->db->from('case_wall');
