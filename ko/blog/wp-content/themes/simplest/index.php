...
<html <?php language_attributes(); ?>>
  <head>
	...
	<link type="text/css" href="/ko/css/ui-lightness/jquery-ui-1.8.22.custom.css" rel="stylesheet" />
	<script type="text/javascript" src="/ko/js/jquery-1.7.2.min.js"></script>
    <script type="text/javascript" src="/ko/js/jquery-ui-1.8.22.custom.min.js"></script>
	<script src="http://www.google.com/jsapi"></script>
	<script src="/ko/js/helpers.js"></script>
	<script>
...
$username = $_COOKIE['casebuy_username'];

?>

<div class="headerWrapper">
	<div class="headerContainer">
		<h1 onclick="location.href='http://casebuy.me/ko/index.php/shop';" style="cursor:pointer">CASEBUY</h1>
		<form method="GET" action="http://casebuy.me/ko/index.php/shop/product_search">
		<ul class="left">
		...
		<ul class="right">
			...
			<li class="cart"><a href="/ko/index.php/shop/cart">장바구니</a></li>
			<li class="notice"><a href="/ko/index.php/shop/notice">공지사항</a></li>
			<li class="qna"><a href="/ko/index.php/shop/qna">Q&A</a></li>
			<?php if ($username){ ?>
			<li class="my"><a href="/ko/index.php/shop/my">MY페이지</a></li>
			<li class="logout"><a href="/ko/index.php/member/logout">로그아웃</a></li>
			<?php } else { ?>
			<li class="login"><a href="/ko/index.php/shop/login">로그인</a></li>
			<li class="join"><a href="/ko/index.php/shop/join">회원가입</a></li>
			<li class="orderQuery"><a href="/ko/index.php/shop/orderQuery">비회원조회</a></li>
			<?php } ?>
