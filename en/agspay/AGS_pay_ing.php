...
/* 		echo ("결제가 실패처리되었습니다. [" . $agspay->GetResult("rSuccYn")."]". $agspay->GetResult("rResMsg").". " ); */
	...
	*******************************************************************/
	...
	$rAGS_HASHDATA	= md5($resultData['rStoreId'] . $resultData['rOrdNo'] . intVal($resultData['rAmt']));
...
<form name="frmAGS_pay_ing" method="post" action="/loveholic/agspay/AGS_pay_result.php">
