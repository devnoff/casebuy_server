		...
		if(Check_Common(form) == true){
			...
			if(document.AGSPay == null || document.AGSPay.object == null){
				...
				if(MakePayMessage(form) == true){										
					...
					var openwin = window.open("/loveholic/agspay/AGS_progress.html","popup","width=300,height=160"); //"지불처리중"이라는 팝업창연결 부분
					
					form.submit();
				}else{
					alert("결제를 취소하였습니다");// 취소시 이동페이지 설정부분
					parent.payment_canceled();
				}
			}
		}
	}
...
<form name=frmAGS_pay method=post action="/loveholic/agspay/AGS_pay_ing.php">
<table border=0 width=100% height=100% cellpadding=0 cellspacing=0>
	<tr>
		...
		<table width=650 border=0 cellpadding=0 cellspacing=0>
			...
			<tr>
				...
				<table width=650 border=0 cellpadding=0 cellspacing=0>
					...
					<tr>
						...
						<td><input type=text style=width:100px name=TempJob maxlength=20 value="<?=$payment_method;?>"></td>
						<td class=clsleft width=180>예) card:iche</td>
					</tr>
					<tr>
						<td class=clsleft >☞ 상점아이디 (20)</td>
						<!--상점아이디를 실거래 전환후에는 발급받은 아이디로 바꾸시기 바랍니다.-->
						<td colspan=2><input type=text style=width:100px name=StoreId maxlength=20 value="yulabs79"></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td colspan=2><input type=text style=width:300px name=ProdNm maxlength=300 value="<?=$product_name;?>"></td>
					</tr>
					<tr>
						<td class=clsleft>☞ 상점URL (50)</td>
						<!-- 주의) 상점홈페이지주소를 반드시 입력해 주십시오. -->
						<!-- (미입력시 특정 카드사 신용카드 결제 및 가상계좌 결제가 이뤄지지 않을 수 있습니다.) -->
						<td><input type=text style=width:300px name=MallUrl value="http://www.scomdcom.com"></td>
						<td class=clsleft>예) http://www.abc.com</td>
					</tr>
					<tr>
						<td class=clsleft>주문자이메일 (50)</td>
						<td colspan=2><input type=text style=width:300px name=UserEmail maxlength=50 value="<?=$result['orderer_email'];?>"></td>
					</tr>
					<tr>
				...
				<table width=650 border=0 cellpadding=0 cellspacing=0>
					<tr>
						...
						<td colspan=2><input type=text style=width:100px name=UserId maxlength=20 value="<?=$result['members_id'];?>"></td>
					</tr>
				</table>
				</div>
				...
				<table width=650 border=0 cellpadding=0 cellspacing=0>
					...
					<tr>
						...
						<td width=300><input type=text style=width:100px name=OrdNm maxlength=40 value="<?=$result['orderer_name'];?>"></td>
						<td width=190></td>
					</tr>
					<tr>
						<td class=clsleft>주문자연락처 (21)</td>
						<td colspan=2><input type=text style=width:100px name=OrdPhone maxlength=21 value="<?=$result['orderer_mobile'];?>"></td>
					</tr>
               		<tr>
						<td class=clsleft>주문자주소 (100)</td><!-- 가상계좌추가 -->
						<td colspan=2><input type=text style=width:300px name=OrdAddr maxlength=100 value="<?=$result['orderer_address'];?>"></td>
					</tr>
					<tr>
						<td class=clsleft>수신자명 (40)</td>
						<td colspan=2><input type=text style=width:100px name=RcpNm maxlength=40 value="<?=$result['recipient_name'];?>"></td>
					</tr>
					<tr>
						<td class=clsleft>수신자연락처 (21)</td>
						<td colspan=2><input type=text style=width:100px name=RcpPhone maxlength=21 value="<?=$result['recipient_mobile'];?>"></td>
					</tr>
					<tr>
						<td class=clsleft>배송지주소 (100)</td>
						<td colspan=2><input type=text style=width:300px name=DlvAddr maxlength=100 value="<?=$result['recipient_address'];?>"></td>
					</tr>
					<tr>
						<td class=clsleft>기타요구사항 (350)</td>
						<td colspan=2><input type=text style=width:300px name=Remark maxlength=350 value="<?=$result['msg'];?>"></td>
					</tr>
					 <tr>
				...
				<table width=650 border=0 cellpadding=0 cellspacing=0>
					...
					<tr>
               		...
               		<tr>
						...
						<td width=300><input type=text style=width:300px name=MallPage value="/loveholic/agspay/AGS_VirAcctResult.php"></td>
			...
			<tr>
				<td align=center>
				<input id="btn_request_payment" type="button" value="지불요청" onclick="javascript:Pay(frmAGS_pay);">
				<!--
