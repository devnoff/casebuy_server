...
$amt = intval($rAmt);
$rAGS_HASHDATA	= md5($rStoreId . $rOrdNo . $amt);				
...
<!--
var openwin = window.open("/loveholic/agspay/AGS_progress.html","popup","width=300,height=160");
openwin.close();
-->
</script>
...
if ($rSuccYn == 'y'){
	...
	if ($AuthTy == 'virtual'){
		// 가상계좌시
		echo "parent.payment_virtual()";
		
	} else {
		// 결제 성공
		echo "parent.payment_success()";
	}
} else {
	// 결제 실패
	echo "parent.payment_failed()";
