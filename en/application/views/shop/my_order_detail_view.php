			...
			?>
				<tr>
					...
					<td class="price"><span>$<?=$i->item_price;?><i></i></span></td>
					<td class="quantity"><?=$i->qty;?></td>
					<td class="final"><span>$<?=$i->item_total_amount;?><i></i></span></td>
				</tr>
			<?php
				}
			?>
				...
				<div class="left">
					<div class="container">
						...
						<table cellpadding="0" cellspacing="0" border="0">
							...
							<tr>
								<th><span>주소</span></th>
								<td>[<?=$order_customer->zipcode;?>] <?=$order_customer->address;?> <?=$order_customer->country;?></td>
							</tr>
				...
				<div class="right">
					<div class="container">
						...
						<table cellpadding="0" cellspacing="0" border="0">
							...
							<tr>
								<th><span>주소</span></th>
								<td>[<?=$order_delivery->zipcode;?>] <?=$order_delivery->address;?> <?=$order_delivery->country;?></td>
							</tr>
			...
			<div class="finalPrice">
				<ul>
					<li class="a"><span>상품금액</span><strong>$<?=$order->totalPrice;?></strong></li>
					<li class="split"><span>+</span></li>
					<li class="b"><span>배송료</span><strong>$<?=$order->delivery_fee;?></strong></li>
					<li class="split"><span>=</span></li>
					<li class="c"><span>결제금액</span><strong>$<?=$order->payable_amount;?></strong></li>
				</ul>
