...
<div style="position:fixed">
	<select id="store_link">
		<option value="http://casebuy.me/ko/index.php/<?=$this->uri->uri_string();?>">한글 스토어</option>
		<option value="http://casebuy.me/en/index.php/<?=$this->uri->uri_string();?>" selected>영문 스토어</option>
	</select>
</div>
<script>
