...
*/
	    ...
	    if ($member && $securePassword == $member->password){
            ...
            */
	        ...
	        set_cookie('loveholic_sessionKey',$sessionKey,3600);
	        set_cookie('loveholic_username',$username,3600);
	...
	function logout(){
	    ...
	    set_cookie('loveholic_none_member','1',0);
	...
	function checkJumin(){
	    ...
	    if (check_jumin($jumin)){
		    ...
		    if ($age > 19){		    
	            ...
	            set_cookie('loveholic_none_member',$none_member_session,3600*5);
